            ...
            <div class="col-md-10 qwe">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <!-- <a href="cv_add.php" class="btn btn-success" style="width: 50%;">Add CV</a> -->
                    </div>

                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3">
                        <form action="cv_search_archive.php" method="POST" class="d-flex">
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    $sql = "SELECT * FROM cv WHERE archive='Yes' ORDER BY cv_Id DESC";
    ...
    $(document).ready(function(){
        ...
        $("#restore_archive_btn").click(function(e){
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: $("#form-delete-user").serialize() + "&action=restorearchiveCV",
