<?php 
    ...
    if(isset($_POST['editOfficialBtn'])){
        ...
        <div class="row">
            ...
            <div class="col-md-10 qwe">
                ...
                <div class="bg-success" style="width: 85%; padding: 8px 20px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light">Official Edit Form</h5>
                </div>
                ...
                <form action="" id="editOfficials_Form" style="width: 85%; margin: 0 auto; border: 1px solid lightgray;" class="p-4" >
                    <input type="text" name="official_Id" id="" value="<?php echo $officials_Id;?>" class="d-none form-control form-control-sm" readonly>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="edit_name" id="name" value="<?php echo $rows['name']?>" class="form-control form-control-sm " required>
                        </div>
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="edit_username" id="user_name" value="<?php echo $rows['username']?>" class="form-control "  required>
                        </div>

                        <div class="col-md-6">
                            <?php $user_type = $rows['user_type']?>
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>User Type:</label>
                            <select name="edit_user_type" id="" class="form-control">
