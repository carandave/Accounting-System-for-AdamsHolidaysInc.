            ...
            <div class="col-md-10 qwe">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <!-- <a href="po_add.php" class="btn btn-success" style="width: 50%;">Add PO</a> -->
                    </div>

                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3">
                        <form action="po_search_archive.php" method="POST" class="d-flex">
                ...
                <div class="bg-success" style="width: 90%; padding: 8px 20px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light ">Archived Purchase Order List</h5>
                </div>
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    $sql = "SELECT * FROM po WHERE archive='Yes' ORDER BY po_Id DESC ";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="justify-content: space-around">
                                ...
                                <!-- <button type="button" class="btn btn-danger btn-sm" id="restore_btn">Restore</button> -->

                                <!-- <form action="" method="POST" id="restore_archive_form" style="width: 50%">
                                    <input type="text" class="" name="restore_po_archive_Id" value="<?php echo $rows['po_Id']?>">
                                    
                                    <input type="submit" id="restore_btn" class="btn btn-success"  style="width: 100%" value="Save">
                                </form> -->
    ...
    $(document).ready(function(){
        ...
        $("#restore_archive_btn").click(function(e){
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: $("#form-delete-user").serialize() + "&action=restorearchivePO",
