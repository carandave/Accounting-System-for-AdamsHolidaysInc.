<div class="bg-dark" style="width: 15%; height: 100%; position: fixed; top: 0; overflow: hidden">
                    <ul class="nav nav-primarybg-success d-flex justify-content-center align-items-center mb-0 mt-4" style="flex-direction: column; width: 100%;">
                        ...
                        <li style="list-style: none; width: 100%; " class="nav-item p-2 text-center">
                            <div class="dropdownli">
                                <a href="sa_list.php" style="font-size: 14px; text-decoration: none" class="px-3 py-2 text-light selectli ">SA List</a>
                            </div>
                        ...
                        <li style="list-style: none; width: 100%; " class="nav-item p-2 text-center">
                            ...
                            <ul class="menu">
                                <li class=""><a href="sa_audit_add.php" style="font-size: 14px; text-decoration: none; color: #fff">Added</a></li>
                                <li><a href="sa_audit_view.php" style="font-size: 14px; text-decoration: none; color: #fff">Viewed</a></li>
                                <li><a href="sa_audit_edit.php" style="font-size: 14px; text-decoration: none; color: #fff">Edited</a></li>
                        ...
                        <?php if($_SESSION['usertype'] == "user"){?>
                            <li style="list-style: none; width: 100%; " class="nav-item  p-2 text-center">
                            <div class="dropdownli">
                                <a href="sa_request_list.php" style="font-size: 14px; text-decoration: none" class="px-3 py-2 text-light selectli ">Requested List</a>
                            </div>
                        ...
                        <li style="list-style: none; width: 100%; " class="nav-item  p-2 text-center">
                            <div class="dropdownli">
                                <a href="sa_archive_list.php" style="font-size: 14px; text-decoration: none" class="px-3 py-2 text-light selectli ">Archived List</a>
                            </div>
                        ...
                        <li style="list-style: none; width: 100%; " class="nav-item  p-2 text-center">
                            <div class="dropdownli">
                                <a href="sa_settings.php" style="font-size: 14px; text-decoration: none" class="px-3 py-2 text-light selectli ">Settings</a>
                            </div>
                        ...
                        <!-- <li style="list-style: none; width: 100%;" class="nav-item  p-2 text-center">
                            <div class="dropdownli d-flex justify-content-center align-items-center" >
                                <a href="dashboard.php" style="font-size: 14px; text-decoration: none; text-align-center" class="text-light selectli " >Home</a>
                            </div>
