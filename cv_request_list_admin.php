        ...
        <div class="row">
            ...
            <div class="col-md-10 qwe">
                ...
                <?php 
                    ...
                    $sql = "SELECT r.req_Id, r.officials_Id, r.form_Id, r.form, r.date_request, r.status, r.token, r.token_expire, r.status, o.officials_Id, o.name, c.cv_Id, c.cv_Number FROM request_list r INNER JOIN officials o ON r.officials_Id = o.officials_Id INNER JOIN cv c ON r.form_Id = c.cv_Id WHERE r.status='Pending'";
                    // $sql = "SELECT r.req_Id, r.officials_Id, r.form_Id, r.form, r.date_request, r.status, r.token, r.token_expire, o.officials_Id, o.name FROM request_list r INNER JOIN officials o ON r.officials_Id = o.officials_Id";
