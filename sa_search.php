            ...
            <div class="col-md-10">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <a href="sa_list.php" class="btn btn-success" style="width: 50%;">Back</a>
                    </div>
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    $sql = "SELECT * FROM sa WHERE archive='No' AND sa_Number like '%$saNoSearch%' OR name_of_client like '%$saNoSearch%'";
