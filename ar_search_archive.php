<?php 
    ...
    if(isset($_POST['searchBtn'])){
        ...
        if($arNoSearch == ""){
            header('Location: ar_archive_list.php');
        }
    }
            ...
            <div class="col-md-10">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <a href="ar_archive_list.php" class="btn btn-success" style="width: 50%;">Back</a>
                    </div>
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    // $sql = "SELECT * FROM ar ORDER BY ar_Id DESC";
                    // $sql = "SELECT * FROM ar WHERE ar_Id like '$arNoSearch'";
                    $sql = "SELECT * FROM ar WHERE archive='Yes' AND ar_Number like '%$arNoSearch%' OR pax_name like '%$arNoSearch%' OR received_from like '%$arNoSearch%'";
