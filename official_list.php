            ...
            <div class="col-md-10 qwe">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <a href="official_add.php" class="btn btn-success" style="width: 50%;">Add OFFICIAL</a>
                    </div>

                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3">
                        <form action="official_search.php" method="POST" class="d-flex">
                            <input type="text" name="search" id="search" class="form-control" placeholder="Search Name" style="width: 70%;">
