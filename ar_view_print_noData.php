                    ...
                    <div class="col-md-4">
                        ...
                        <div>
                            ...
                            <table class="table table-sm" style="border: 1px solid lightgray">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pr-0 " style="font-size: 14px;">US$ <span class="font-weight-bold text-center ml-2 mr-0"></span></td>
                                        <td colspan="9" style="border: 1px solid lightgray" class="text-center"><span class="font-weight-bold text-center ml-2 mr-0" style="font-size: 14px;"></span></td>
                                        <td colspan="6" style="border: 1px solid lightgray" class="text-center"><span class="font-weight-bold text-center ml-2 mr-0" style="font-size: 14px;"></span></td>
                                    ...
                                    <tr class="mt-5">
                                        ...
                                        <td colspan="9" style="border: 1px solid lightgray"></td>
                                        <td colspan="6" style="font-size: 14px;border: 1px solid lightgray " class="font-weight-bold text-center"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="9" style="font-size: 14px;border: 1px solid lightgray" class="text-center font-weight-bold"></td>
                                    ...
                                    <?php }?>
                                        ...
                                        <td colspan="6" style="font-size: 14px;border: 1px solid lightgray" class="text-center font-weight-bold">PHP <span class="font-weight-bold text-center ml-2 mr-0"></span></td>
                                    </tr>
                        ...
                        <div class="" style="width: 100%;">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-9 px-0">
                                    <input type="text" style="font-weight: bold; text-align: center; width: 100%; border: 0px; border-bottom: 1px solid gray" value="" class="" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-md-9 px-0">
                                    <input type="text" style="font-size: 15px; text-transform: uppercase; font-weight: bold; text-align: center; width: 100%; border: 0px; border-bottom: 1px solid gray" value="" class="" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-md-8 px-0">
                                    <input type="text" style="font-size: 15px; font-weight: bold; text-align: center; width: 100%; border: 0px; border-bottom: 1px solid gray" value="" class="" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-6 " >
                                    ...
                                    <div class="row">
                                        <div class="col-md-6  d-flex justify-content-center align-items-center px-0">
                                            <span class="">OR No.</span>
                                        </div>
                                        <div class="col-md-6  px-0">
                                            <input type="text" style="font-weight: bold; width: 100%; border: 0px; " value="" class="" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 " style="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 px-0">
                                            <input type="text" style="font-weight: bold;text-align: center; width: 100%; border: 0px; border-bottom: 1px solid gray: background-color: red !important;" value="" class="" readonly>
                                            <!-- <p class="text-center">Authorized Signature</p> -->
                                        </div>
                                    </div>
