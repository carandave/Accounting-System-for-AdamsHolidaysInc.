            ...
            <div class="col-md-10 qwe">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <a href="sa_add.php" class="btn btn-success" style="width: 50%;">Add SA</a>
                    </div>

                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3">
                        <form action="sa_search.php" method="POST" class="d-flex">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3 ">
                        <a href="sa_list_export_view.php" class="btn btn-success ">Export to Excel</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="justify-content: space-around">
                                <!-- <form action="sa_edit.php" method="POST">
                                    <input type="text" class="d-none" name="sa_Id" value="<?php echo $rows['sa_Id'];?>">
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-id="<?php echo $rows['sa_Id'];?>" onclick="requestEditModal(this);">
                                    Request Edit
                                </button>
                                ...
                                <form action="sa_view.php" method="POST">
                                    <input type="text" class="d-none" name="sa_Id" value="<?php echo $rows['sa_Id'];?>">
                                    <input type="submit" class="btn btn-primary btn-sm" name="view" value="VIEW">
                                </form>

                                <form action="sa_view_print.php" method="POST" >
                                    <input type="text" class="d-none" name="sa_Id" value="<?php echo $rows['sa_Id'];?>">
                                ...
                                <!-- <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#sa_archive_modal<?php echo $rows['sa_Id']?>">
                                Archive
                                </button>

                                
                                <div class="modal fade" id="sa_archive_modal<?php echo $rows['sa_Id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <div class="modal-body d-flex justify-content-center align-items-center" style="flow-direction: column">
                                        <form action="" id="archive_form" style="width: 50%">
                                            <input type="text" class="" name="sa_archive_Id" value="<?php echo $rows['sa_Id']?>">
