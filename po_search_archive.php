<?php 
    ...
    if(isset($_POST['searchBtn'])){
        ...
        if($poNoSearch == ""){
            header('Location: po_archive_list.php');
        }
    }
            ...
            <div class="col-md-10">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <a href="po_archive_list.php" class="btn btn-success" style="width: 50%;">Back</a>
                    </div>
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    $sql = "SELECT * FROM po WHERE archive='Yes' AND po_Number like '%$poNoSearch%'";
