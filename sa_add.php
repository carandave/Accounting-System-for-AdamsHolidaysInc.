        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="bg-success" style="width: 90%; padding: 15px 35px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light text-center">STATEMENT OF ACCOUNT ENTRY FORM</h5>
                </div>
                ...
                <input type="text" name="by" id="" value="<?php echo $userName;?>" class="d-none form-control form-control-sm" readonly>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name_of_client" id="name_of_client" class="form-control form-control-sm " required>
                        </div>

                        <div class="col-md-6">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Agent:</label>
                            <input type="text" name="agent" id="agent" class="form-control form-control-sm" required>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea cols="10" rows="3" name="group_name" id="group_name" class="form-control form-control-sm" required>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea cols="10" rows="4" name="particulars" id="particulars" class="form-control form-control-sm" required>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="co" id="co" class="form-control form-control-sm" required>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="po_no" id="po_no" class="form-control form-control-sm " required>
                        </div>

                        <div class="col-md-6">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>AR No.:</label>
                            <input type="text" name="or_no" id="or_no" class="form-control form-control-sm" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="sa_preparedBy" id="ar_preparedBy" class="form-control form-control-sm" required>
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Checked By:</label>
                            <input type="text" name="sa_checkedBy" id="ar_checkedBy" class="form-control form-control-sm" required>
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Approved By:</label>
                            <input type="text" name="sa_approvedBy" id="ar_approvedBy" class="form-control form-control-sm" required>
                        </div>
                    </div>
                            ...
                            <div class="row p-3">
                                <div class="col-md-6 " style="border-right: 3px solid white">
                                    <div class="d-flex ">
                                        ...
                                        <input type="radio" name="sa_paymentMethod" onclick="selectedUsdPhpHotel()" value="USD" id="usdChosePaymentMethod" class="form-control " required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6" style="border-left: 3px solid white">
                                    <div class="d-flex ">
                                        ...
                                        <input type="radio" name="sa_paymentMethod" onclick="selectedUsdPhpHotel()" value="PHP" id="phpChosePaymentMethod" class="form-control " required >
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row bg-warning p-3 m-1 " id="acr-div">
                        <div class="col-md-12 ">
                            ...
                            <input type="number" name="sa_acr" id="sa_acr" class="form-control form-control-sm" required value="0">
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 ">
                            <div class="p-3 bg-success" style="border: 1px solid lightgray;">
                                <div class="">
                                    ...
                                    <input type="text" name="sa_passengerName[]" id="sa_passengerName" class="form-control form-control-sm" required value="N/A">
                                </div>
                                ...
                                <div class="row mt-3">
                                        <div class="col-md-3 d-flex justify-content-center" style="align-items: self-end;">
                                            <select name="" id="payment_option_fare" class="select-Fee-1 form-control">
                                        ...
                                        <div class="col-md-9">
                                            <!-- TOUR COST ROW -->
                                            <div class="select-tourCost-1 row" >
                                                <div class="col-md-12">
                                                ...
                                                <h6 class="text-light">TOUR COST</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="tourcost_usd[]" oninput="select1();" id="tourcost1_usd" class="tourcost1_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            ...
                                                            <input type="number" name="tourcost_arc[]" oninput="" id="tourcost1_arc" class="tourcost1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="tourcost_php[]" oninput="selectphp1();" id="tourcost1_php" class="tourcost1_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- TAXES ROW -->
                                            <div class="select-taxes-1 row mt-2" >
                                                <div class="col-md-12">
                                                ...
                                                <h6 class="text-light">TAXES</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="taxes_usd[]" oninput="select1();" id="taxes1_usd" class="taxes1_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="taxes_arc[]" oninput="" id="taxes1_arc" class="taxes1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="taxes_php[]" oninput="selectphp1();" id="taxes1_php" class="taxes1_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- TIP FUND ROW -->
                                            <div class="select-tipFund-1 row mt-2" >
                                                <div class="col-md-12">
                                                ...
                                                <h6 class="text-light">TIP FUND</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="tip_fund_usd[]" oninput="select1();" id="tip_fund1_usd" class="tip_fund1_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="tip_fund_arc[]" oninput="" id="tip_fund1_arc" class="tip_fund1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="tip_fund_php[]" oninput="selectphp1();" id="tip_fund1_php" class="tip_fund1_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="select-travelInsurance-1 row mt-2" >
                                                <div class="col-md-12">
                                                ...
                                                <h6 class="text-light">TRAVEL INSURANCE</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="travel_insurance_usd[]" oninput="select1();" id="travel_insurance1_usd" class="travel_insurance1_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="travel_insurance_arc[]" oninput="" id="travel_insurance1_arc" class="travel_insurance1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="travel_insurance_php[]" oninput="selectphp1();" id="travel_insurance1_php" class="travel_insurance1_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- VISA FEE ROW -->
                                            <div class="select-visaFee-1 row mt-2" >
                                                <div class="col-md-12">
                                                ...
                                                <!-- <h6>VISA FEE</h6> -->
                                                    <div class="row pr-3">
                                                        <div class="col-md-9 ">
                                                            ...
                                                            <input type="text" name="visa_fee_name[]" oninput="" id="visa_fee1_name" class="visa_fee1_name visa-fee-parent1 form-control form-control-sm pr-3" value="N/A" required>
                                                        </div>

                                                        <div class="col-md-3">
                                                            <label for="" class="font-weight-bold " style="visibility: hidden"><span class="text-danger">*</span>VISA FEE:</label>
                                                            <input type="button" class="addVisaFeeTab1 btn btn-dark btn-block" style="border: 0; cursor: pointer;" value="ADD VISA FEE" id="addVisaFeeTab1">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="visa_fee_usd[]" oninput="select1();" id="visa_fee1_usd" class="visa_fee1_usd Parent1_visa_fee_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="visa_fee_arc[]" oninput="" id="visa_fee1_arc" class="visa_fee1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="visa_fee_php[]" oninput="selectphp1();" id="" class="visa_fee1_php Parent1_visa_fee_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-3 d-none">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="nested_visa_fee_subtotal_usd[]" oninput="" id="" class="nested1_subtotal_usd nested_visa_sub_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="nested_visa_fee_subtotal_php[]" oninput="" id="" class="nested1_subtotal_php nested_visa_sub_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                    
                                                    <div id="netxVisaFeeTab1">
                                            ...
                                            <!-- OTHER ROW -->
                                            <div class="select-other-1 row mt-2" >
                                                <div class="col-md-12">
                                         
                                                    <div class="row pr-3">
                                                        <div class="col-md-9">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER:</label>
                                                            <input type="text" name="other_name[]" oninput="" id="other1_name" class="other1_name other-parent1 form-control form-control-sm" value="N/A" required>
                                                        </div>

                                                        <div class="col-md-3">
                                                            <label for="" class="font-weight-bold" style="visibility: hidden"><span class="text-danger">*</span>OTHER:</label>
                                                            <input type="button" class="addOtherTab1 btn btn-dark btn-block" style="border: 0; cursor: pointer;" value="ADD OTHER" id="addOtherTab1">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="other_usd[]" oninput="select1();" id="other1_usd" class="other1_usd Parent1_other_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="other_arc[]" oninput="" id="" class="other1_arc form-control form-control-sm " value="0" required>
                                                            <input type="number" name="other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="other_php[]" oninput="selectphp1();" id="" class="other1_php Parent1_other_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-3 d-none">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED 1 SUBTOTAL USD:</label>
                                                            <input type="number" name="nested_other_subtotal_usd[]" oninput="" id="" class="nested1_other_subtotal_usd nested_other_sub_usd form-control form-control-sm" value="0" required>
                                                            <input type="number" name="" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED 1 SUBTOTAL PHP:</label>
                                                            <input type="number" name="nested_other_subtotal_php[]" oninput="" id="" class="nested1_other_subtotal_php nested_other_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>

                                                    <div id="netxOtherTab1">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" name="select1_total_usd[]" oninput="" id="select1_total_usd" class="select1_total_usd form-control form-control-sm" value="0" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" name="select1_total_php[]" oninput="" id="select1_total_php" class="select1_total_php form-control form-control-sm" value="0" required>
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4" >
                            ...
                            <input type="number" name="sub_total_usd" oninput="" id="sub_total_usd" class="sub_total_usd form-control form-control-sm" value="0" readonly="true">
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>SUB TOTAL PHP:</label>
                            <input type="number" name="sub_total_php" oninput="" id="sub_total_php" class="sub_total_php form-control form-control-sm" value="0" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-8" >
                            ...
                            <input type="number" name="total_of_sub_total" oninput="" id="total_of_sub_total" class="total_of_sub_total form-control form-control-sm" value="0" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="p-3 pb-0 mt-4" style="border: 1px solid lightgray;">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="sa_amount_deposit[]" oninput="addDeposit()" id="sa_amount_deposit" class="sa_amount_deposit form-control form-control-sm" value="0" required>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="total_amount_deposit" oninput="" id="total_amount_deposit" class="total_amount_deposit form-control form-control-sm" value="0" readonly="true">
                            </div>
                            <!-- <div class="col-md-2">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="total_amount" oninput="" id="total_amount" class="total_amount form-control " value="0" readonly="true">
                            </div>
                            <!-- <div class="col-md-2">
                                <label for="" class="font-weight-bold" style="visibility: hidden"><span class="text-danger mr-1">*</span>TOTAL AMOUNT DEPOSIT:</label>
                                <input type="text" name="total_amount_deposit" style="visibility: hidden" oninput="" id="total_amount_deposit" class="total_amount_deposit form-control form-control-sm" value="0" required>
...
<script>
    ...
    // let sa_acr1 = document.getElementById("sa_acr");

    // console.log(sa_acr1);
    // sa_acr1.addEventListener("click", function(){
    //     alert("qwe");
    // })
...
valuesNested6OtherPhp = valuesNested6OtherPhp.map(item => (item == "" ? 0 : item));
        ...
        // Sa edit naman natin aayusin ang Remove Nested
    ...
    $("#addVisaFeeTab1").on("click", function(e) {
        ...
        VisaFeecols += '    <div class="col-md-10 ">'
        ...
        VisaFeecols += '    </div>'
        VisaFeecols += '    <div class="col-md-2">'
        VisaFeecols += '        <label for="" class="font-weight-bold " style="visibility: hidden"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
...
function nested9VisaFeeCal(){
    ...
    $("#addPassengerTab").on("click", function(e) {
            ...
            cols +=     '</div>'
            cols += '    <input type="text" name="sa_passengerName[]" id="sa_passengerName" class="sa_passengerName form-control form-control-sm" required value="N/A">'
            cols += '</div>'
            ...
            cols += '                               <input type="button" class="btn btn-dark btn-block" onclick="addVisaFee'+counter+'()" style="border: 0; cursor: pointer;" value="ADD VISA FEE" id="addVisaFeeTab'+counter+'">'
            cols += '                           </div>'
            cols += '                   </div>'
            ...
            cols += '                           <input type="number" name="nested_visa_fee_subtotal_usd[]" oninput="" id="" class="nested'+counter+'_subtotal_usd nested_visa_sub_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                           <input type="number" name="nested_visa_fee_subtotal_php[]" oninput="" id="" class="nested'+counter+'_subtotal_php nested_visa_sub_php form-control form-control-sm" value="0" required>'
            cols += '                       </div>'
            cols += '                   </div>'
            ...
            cols += '                                                <input type="button" class="btn btn-dark btn-block" onclick="addOther'+counter+'()" style="border: 0; cursor: pointer;" value="ADD OTHER" id="addOtherTab'+counter+'">'
            cols += '                                            </div>'
            cols += '                                       </div>'
            ...
            cols += '                                            <div class="col-md-4">'
            cols += '                                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED '+counter+' SUBTOTAL USD:</label>'
            cols += '                                                <input type="number" name="nested_other_subtotal_usd[]" oninput="" id="" class="nested'+counter+'_other_subtotal_usd nested_other_sub_usd form-control form-control-sm" value="0" required>'
            cols += '                                                <input type="number" name="" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
            cols += '                                            </div>'
            ...
            cols += '                                            <div class="col-md-4">'
            cols += '                                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED 1 SUBTOTAL PHP:</label>'
            cols += '                                                <input type="number" name="nested_other_subtotal_php[]" oninput="" id="" class="nested'+counter+'_other_subtotal_php nested_other_php form-control form-control-sm" value="0" required>'
            cols += '                                            </div>'
            cols += '                                        </div>'
    ...
    $(document).ready(function(){
        ...
        // console.log("Hello World")
            $("#addBtn").click(function(e){
                    ...
                    var sa_paymentMethod = document.getElementsByName('sa_paymentMethod');
