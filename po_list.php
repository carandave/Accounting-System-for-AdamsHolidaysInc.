            ...
            <div class="col-md-10 qwe">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3">
                        <form action="po_search.php" method="POST" class="d-flex">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3 ">
                        <a href="po_list_export_view.php" class="btn btn-success ">Export to Excel</a>
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    $sql = "SELECT * FROM po WHERE archive='No' ORDER BY po_Id DESC ";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="justify-content: space-around">
                                ...
                                <button type="button" class="btn btn-success btn-sm" data-id="<?php echo $rows['po_Id'];?>" onclick="requestEditModal(this);">
                                    Request Edit
                                </button>
