            ...
            <div class="col-md-10 qwe">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3">
                        <form action="cv_search.php" method="POST" class="d-flex">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-end pr-5 mb-3 ">
                        <a href="cv_list_export_view.php" class="btn btn-success ">Export to Excel</a>
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    $sql = "SELECT * FROM cv WHERE archive='No' ORDER BY cv_Id DESC";
