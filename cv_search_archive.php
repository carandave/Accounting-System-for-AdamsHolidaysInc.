<?php 
    ...
    if(isset($_POST['searchBtn'])){
        ...
        if($cvNoSearch == ""){
            header('Location: cv_archive_list.php');
        }
    }
            ...
            <div class="col-md-10">
                ...
                <div class="row mt-3">
                    <div class="col-md-6 pl-5 mb-3 ">
                        <a href="cv_archive_list.php" class="btn btn-success" style="width: 50%;">Back</a>
                    </div>
                ...
                <div class="bg-success" style="width: 90%; padding: 8px 20px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light">Archived Check Voucher List</h5>
                </div>
                ...
                <table class="table table-bordered table-hover table-sm" style="width: 90%; margin: 0 auto;">
                    ...
                    $sql = "SELECT * FROM cv WHERE archive='Yes' AND cv_Number like '%$cvNoSearch%'";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="justify-content: space-around">
                                ...
                                <!-- <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#ar_archive_modal<?php echo $rows['cv_Id']?>">
                                Archive
                                </button>

                                
                                <div class="modal fade" id="ar_archive_modal<?php echo $rows['cv_Id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <div class="modal-body d-flex justify-content-center align-items-center" style="flow-direction: column">
                                        <form action="" method="POST" id="archive_form" style="width: 50%">
                                            <input type="text" class="" name="cv_archived_Id" value="<?php echo $rows['cv_Id']?>">
    ...
    $(document).ready(function(){
        ...
        $("#restore_archive_btn").click(function(e){
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: $("#form-delete-user").serialize() + "&action=searchrestorearchiveCV",
                    success : function (response){

                        if(response == "successArchive1"){
                                Swal.fire({
                                    position: 'center',
                                    icon: 'success',
                        ...
                        else if(response == "errorArchive1"){
                                Swal.fire({
                                    position: 'center',
                                    icon: 'success',
