        ...
        <div class="row">
            ...
            <div class="col-md-10 qwe">
                ...
                <div class="bg-success" style="width: 90%; padding: 8px 20px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light">Requested Statement of Account List</h5>
                </div>
                
                <?php 
                    
                    $sql = "SELECT r.req_Id, r.officials_Id, r.form_Id, r.form, r.date_request, r.status, r.token, r.token_expire, o.officials_Id, o.name, s.sa_Id, s.sa_Number FROM request_list r INNER JOIN officials o ON r.officials_Id = o.officials_Id INNER JOIN sa s ON r.form_Id = s.sa_Id WHERE r.officials_Id = $officials_Id AND r.token_expire>NOW() ";
