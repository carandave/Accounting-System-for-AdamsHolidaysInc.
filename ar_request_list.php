        ...
        <div class="row">
            ...
            <div class="col-md-10 qwe">
                ...
                <div class="bg-success" style="width: 90%; padding: 8px 20px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light">Requested Acknowledgement Receipt List</h5>
                </div>
                
                <?php 
                    
                    $sql = "SELECT r.req_Id, r.officials_Id, r.form_Id, r.form, r.date_request, r.status, r.token, r.token_expire, o.officials_Id, o.name, a.ar_Id, a.ar_Number FROM request_list r INNER JOIN officials o ON r.officials_Id = o.officials_Id INNER JOIN ar a ON r.form_Id = a.ar_Id WHERE r.officials_Id = $officials_Id AND r.token_expire>NOW() ";
