        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="row mt-4" style="width: 100%; margin: 0 auto;">
                    <div class="col-md-4">
                        <div>
                            <div class="bg-success d-flex justify-content-center" style="border: 1px solid lightgray">
                            ...
                            <table class="table table-sm" style="border: 1px solid lightgray">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="6" style="border: 1px solid lightgray">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="9" style="border: 1px solid lightgray"></td>
                                        <td colspan="6" style="border: 1px solid lightgray">
                                            <input type="checkbox" id="local_tours" class="form-control mb-0"
                    ...
                    <div class="col-md-8">
                        <div class="" style="width: 100%;">
                            <h4 class="m-0" style="text-align: left; width: 100%;">ACKNOWLEDGEMENT RECEIPT</h4>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-md-9 px-0">
                                    <input type="text" style="font-size: 15px; text-transform: uppercase; font-weight: bold; text-align: center; width: 100%; border: 0px; border-bottom: 1px solid gray" value="<?php echo $rows['sum']?>" class="" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-md-8 px-0">
                                    <input type="text" style="font-size: 15px; font-weight: bold; text-align: center; width: 100%; border: 0px; border-bottom: 1px solid gray" value="<?php echo $rows['full']?>" class="" readonly>
                                </div>
                            </div>
                ...
                <!-- <div class="card-body m-5" id="printThis" style="visibility: hidden"> -->
                ...
                <div class="row mt-4" style="width: 100%; margin: 0 auto; ">
                    <div class="col-md-4">
                        <div>
                            ...
                            <?php $transaction = $rows['transaction'];?>
                            <input type="text" value="<?php echo $transaction?>" style="visibility: hidden" class="d-none" id="transactionCheck" >
                            <table class="table table-sm " style="border: 0px; margin-top: -55px; ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="13" style="visibility: hidden; border: 0px;"></td>
                                        <td colspan="6" style="border: 0px;" class="">
                                            <input type="checkbox" id="initial_travel" class="ml-2 form-control mb-0"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6" style="border: 0px;">
                                            <input type="checkbox" id="local_tours" style="" class="ml-2 form-control mb-0"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="13" style="border: visibility: hidden; border: 0px;"></td>
                                        <td colspan="6" style="border: 0px;">
                                            <input type="checkbox" id="domestic_tours"  class="ml-2 form-control mb-0" 
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="13" style="visibility: hidden; border: 0px;"></td>
                                        <td colspan="6" style="border: 0px;">
                                            <input type="checkbox" id="others"  class="ml-2 form-control mb-0"
                        ...
                        <div>
                            ...
                            <table class="table table-sm " style="margin-top: 45px; ">
                                <thead style="">
                                    
                                </thead>
                                <tbody>
                                    <tr style="border: 0px;">
                                        <td class="pr-0 " style="font-size: 14px; border: 0px;"><span style="visibility: hidden">US$</span> <span class="font-weight-bold text-right ml-2 mr-0 pl-3"><?php echo $rows['usd_amount']?></span></td>
                                        <td colspan="13" style="border: 0px;" class="text-right"><span class="font-weight-bold text-right ml-2 mr-0 pl-3" style="font-size: 14px;"><?php echo $rows['acr']?></span></td>
                                        <td colspan="10" style="border: 0px;" class="text-right"><span class="font-weight-bold text-right ml-2 mr-0 pl-3" style="font-size: 14px;"><?php echo $rows['php_val']?></span></td>
                                    ...
                                    <tr class="mt-5" style="border: 0px;">
                                        ...
                                        <td colspan="10" style="font-size: 14px; border: 0px;" class="font-weight-bold text-right pl-3"><?php echo $rows['cash_amount'];?></td>
                                    </tr>
                                    ...
                                    <tr style="border: 0px;">
                                        <td style="font-size: 14px; visibility: hidden; border: 0px;">CHECK AMOUNT </td>
                                        <td colspan="9" style="border: 0px;"></td>
                                        <td colspan="10" style="font-size: 14px; border: 0px;" class="font-weight-bold text-right">
                                            <?php foreach($checkAmount1Arr as $checkAmount1ArrValue){?>
                                                <?php 
                                                echo '<small>';
                                                echo $checkAmount1ArrValue;
                                    ...
                                    <tr style="border: 0px;">
                                        ...
                                        <td style="font-size: 14px; visibility: hidden; border: 0px;">CHECK NO.</td>
                                        <td colspan="13" style="font-size: 14px; border: 0px;" class="text-right font-weight-bold">
                                            <?php foreach($checkNo1Arr as $checkNo1ArrValue){?>
                                                <?php 
                                                echo '<small>';
                                                echo $checkNo1ArrValue;
                                                echo ',';
                                                echo '</small>';
                                                echo '</br>';
                                                ?>
                                        ...
                                        <td style="font-size: 14px; visibility: hidden; border: 0px;">TOTAL</td>
                                        <td colspan="13" style="border: 0px;" class="text-right"></td>
                                        <td colspan="10" style="font-size: 14px; border: 0px;" class="text-right font-weight-bold">PHP <span class="font-weight-bold text-center ml-2 mr-0"><?php echo $rows['total_amount']?></span></td>
                                    </tr>
                        ...
                        <div class="mt-2.5" style="width: 100%;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 ">
                                    <div class="row">
                                        <div class="col-md-5 ">
                                            <span style="visibility: hidden; text-align: left">AR No.: </span>
                                        </div>

                                        <div class="col-md-7">
                                            <span class="font-weight-bold" style="margin-left: -10px; text-align: left"><?php echo $rows['ar_Number']?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9" >
                                                <span class="" style="margin-left: -10px; text-align: left">
                                                <br>
                                                <?php 
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-9 px-0">
                                    <?php 
                                    $sumofPesos =  $rows['sum'];
                                    $trimSumofPesos = trim($sumofPesos);

                                    echo '<textarea name="" style="font-size: 15px; text-transform: uppercase; font-weight: bold; text-align: left; width: 90%; border: 0px; " id="" cols="50" rows="2" class="readonly">' . $trimSumofPesos . '</textarea>';
                                    ?>
                                    <!-- <textarea name="" style="font-size: 15px; text-transform: uppercase; font-weight: bold; text-align: left; width: 90%; border: 0px; " id="" cols="50" rows="2" class="readonly">
                                        <?php echo $trimSumofPesos?>
                                    </textarea> -->
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-8 px-0">
                                    ...
                                    echo '<input type="text" style="font-size: 15px; font-weight: bold; width: 100%; border: 0px;" value="'.$trimFull.'" class="" readonly>';
                                ...
                                <div class="col-md-6 " >
                                    ...
                                    <div class="row">
                                        <div class="col-md-6  d-flex justify-content-center align-items-center px-0">
                                            ...
                                            <span style="visibility: hidden">Ref No.</span>
                                        </div>
                                        <div class="col-md-6 px-0">
                                            <input type="text" style="font-weight: bold; text-align: left; width: 100%; border: 0px; " value="<?php echo $rows['PR_no']?>" class="" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 " style="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 px-0">
                                            ...
                                            <br>
                                            <input type="text" style="font-weight: bold; text-align: left; width: 100%; border: 0px; border-bottom: 1px solid gray: background-color: red !important;" value="<?php echo $rows['by_signature']?>" class="" readonly>
                                            <!-- <p class="text-center">Authorized Signature</p> -->
                                        </div>
                                    </div>
