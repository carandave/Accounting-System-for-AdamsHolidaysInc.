        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <form action="" id="po_Form" style="width: 85%; margin: 0 auto; border: 1px solid lightgray;" class="p-4" >
                    ...
                    <input type="text" name="category" id="category" class="form-control form-control-sm d-none" value="" required>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-airfare" role="tabpanel" style="background-color: white">
                                            ...
                                            <div class="row p-3 mx-0">
                                                <div class="col-md-6 mx-0" style="border-right: 3px solid white">
                                                    <div class="d-flex ">
                                                        ...
                                                        <input type="radio" name="airfare_paymentMethod" onclick="selectedUsdPhpAirfare()" value="USD" id="usdChosePaymentMethod" class="form-control " required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mx-0" style="border-left: 3px solid white">
                                                    <div class="d-flex ">
                                                        ...
                                                        <input type="radio" name="airfare_paymentMethod" onclick="selectedUsdPhpAirfare()" value="PHP" id="phpChosePaymentMethod" class="form-control " required >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row bg-warning p-3 m-1 " id="acr-div">
                                        <div class="col-md-12 ">
                                            ...
                                            <input type="number" name="airfare_acr" id="acr" class="form-control form-control-sm" required value="0">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-8 d-flex">
                                                    ...
                                                    <input type="text" name="airfare_passengerName[]" oninput="" style="height: 35px;" id="passengername_airfare" class="passengername_airfare form-control form-control-sm" value="N/A" required>
                                                </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 d-flex">
                                                    ...
                                                    <input type="number" name="airfare_usd[]" oninput="subtotalusd()" style="height: 35px;" id="airfare_usd" class="airfare_usd form-control form-control-sm input-sm" value="0" required>
                                                </div>
                                                ...
                                                <div class="col-md-4 d-flex">
                                                    ...
                                                    <input type="number" name="airfare_php[]" oninput="subtotalphp()" id="airfare_php" style="height: 35px;" class="airfare_php form-control" value="0" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 d-flex">
                                                <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">USD: </span></label>
                                                    <input type="number" name="taxes_usd[]" oninput="subtotalusd()" id="taxes_usd" style="height: 35px;" class="taxes_usd form-control" value="0" required>
                                                </div>

                                                <div class="col-md-4 d-flex">
                                                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">PHP: </span></label>
                                                    <input type="number" name="taxes_php[]" oninput="subtotalphp()" id="taxes_php" style="height: 35px;" class="taxes_php form-control" value="0" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 d-flex">
                                                <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">USD: </span></label>
                                                    <input type="number" name="iata_usd[]" oninput="subtotalusd()" id="iata_usd" style="height: 35px;" class="iata_usd form-control" value="0" required>
                                                </div>

                                                <div class="col-md-4 d-flex">
                                                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">PHP: </span></label>
                                                    <input type="number" name="iata_php[]" oninput="subtotalphp()" id="iata_php" style="height: 35px;" class="iata_php form-control form-control-sm" value="0" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    <input type="number" name="airfare_sub_total_usd[]" oninput="" id="sub_total_usd" style="height: 35px;" class="sub_total_usd form-control" value="0" readonly>
                                                </div>
                                                ...
                                                <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white mb-0 d-flex justify-content-center align-items-center" style="font-size: 12px; height: 35px;" ><span >TOTAL PHP: </span></label>
                                                    <input type="number" name="airfare_sub_total_php[]" oninput="" id="sub_total_php" style="height: 35px;" class="sub_total_php form-control form-control-sm" value="0" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row p-3 mt-2" style="margin: 0 5px;">
                                        ...
                                        <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white"><span class="text-center">USD: </span></label>
                                            <input type="number" name="airfare_final_sub_total_usd" oninput="" id="final_sub_total_usd" style="height: 40px;" class="final_sub_total_usd form-control" value="0" readonly>
                                        </div>

                                        <div class="col-md-4 d-flex">
                                            <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white"><span class="text-center">PHP: </span></label>
                                            <input type="number" name="airfare_final_sub_total_php" oninput="" id="final_sub_total_php" style="height: 40px;" class="final_sub_total_php form-control form-control-sm" value="0" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="airfare_amountInWords" style="text-transform: uppercase;" id="airfare_amountInWords" class="form-control form-control-sm" value="N/A" readonly>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pills-hotel_landarrangement" role="tabpanel" style="background-color: white" >
                                        ...
                                        <div class="col-md-12 mx-0">
                                            <div class="row p-3 mx-0">
                                                <div class="col-md-6 mx-0" style="border-right: 3px solid white">
                                                    <div class="d-flex ">
                                                        <label for="" class="font-weight-bold text-light mb-0"><span class="text-danger mr-1 ">*</span>USD:</label>
                                                        <input type="radio" name="hotel_paymentMethod" onclick="selectedUsdPhpHotelLand()" value="USD" id="usdChoseHotel" class="form-control " required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mx-0" style="border-left: 3px solid white">
                                                    <div class="d-flex ">
                                                        <label for="" class="font-weight-bold text-light mb-0"><span class="text-danger mr-1">*</span>PHP:</label>
                                                        <input type="radio" name="hotel_paymentMethod" onclick="selectedUsdPhpHotelLand()" value="PHP" id="phpChoseHotel" class="form-control " required >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row bg-warning p-3 m-1 " id="hotel-acr-div">
                                        <div class="col-md-12 ">
                                            <label for="" class="font-weight-bold text-dark"><span class="text-danger mr-1">*</span>ACR:</label>
                                            <input type="number" name="hotel_acr" oninput="" id="hotel_acr" class="form-control form-control-sm" required value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row bg-success p-3 pb-4 mt-3" style="margin: 0 5px;">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-8 d-flex">
                                                    <input type="text" name="hotel_passengerName[]" style="height: 35px;" id="hotel_passengerName" class="hotel_passengerName form-control form-control-sm" value="N/A" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 d-flex">
                                                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">USD: </span></label>
                                                    <input type="number" name="hotel_hotel_usd" oninput="hotellandusd()" style="height: 35px;" id="hotel_hotel_usd" class="hotel_hotel_usd form-control form-control-sm input-sm" value="0" required>
                                                </div>

                                                <div class="col-md-4 d-flex">
                                                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">PHP: </span></label>
                                                    <input type="number" name="hotel_hotel_php" oninput="hotellandphp()" id="hotel_hotel_php" style="height: 35px;" class="hotel_hotel_php form-control" value="0" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 d-flex">
                                                <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">USD: </span></label>
                                                    <input type="number" name="hotel_taxes_usd" oninput="hotellandusd()" id="hotel_taxes_usd" style="height: 35px;" class="hotel_taxes_usd form-control" value="0" required>
                                                </div>

                                                <div class="col-md-4 d-flex">
                                                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">PHP: </span></label>
                                                    <input type="number" name="hotel_taxes_php" oninput="hotellandphp()" id="hotel_taxes_php" style="height: 35px;" class="hotel_taxes_php form-control" value="0" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 d-flex justify-content-center align-items-center">
                                                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white mb-0  d-flex justify-content-center align-items-center" style="font-size: 12px; height: 35px;" ><span class="mb-0">TOTAL USD: </span></label>
                                                    <input type="number" name="hotel_sub_total_usd" oninput="" id="hotel_sub_total_usd" style="height: 35px;" class="hotel_sub_total_usd form-control" value="0" readonly>
                                                </div>

                                                <div class="col-md-4 d-flex">
                                                <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white mb-0 d-flex justify-content-center align-items-center" style="font-size: 12px; height: 35px;" ><span >TOTAL PHP: </span></label>
                                                    <input type="number" name="hotel_sub_total_php" oninput="" id="hotel_sub_total_php" style="height: 35px;" class="hotel_sub_total_php form-control form-control-sm" value="0" readonly>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Amount in Words:</label>
                                            <input type="text" name="hotelland_amountInWords" style="text-transform: uppercase;" id="hotelland_amountInWords" class="form-control form-control-sm" value="N/A" readonly>
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="po_preparedBy" id="ar_preparedBy" value="<?php echo $userName;?>" class="form-control form-control-sm" required>
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Checked By:</label>
                            <input type="text" name="po_checkedBy" id="ar_checkedBy" class="form-control form-control-sm" required>
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Approved By:</label>
                            <input type="text" name="po_approvedBy" id="ar_approvedBy" class="form-control form-control-sm" required>
                        </div>
                    </div>
...
<script>
    ...
    $('.addPassengerTab').click(function(e){
        ...
        var cols    = ""
            ...
            cols += '                    <input type="text" name="airfare_passengerName[]" oninput="" style="height: 35px;" id="passengername_airfare" class="passengername_airfare form-control form-control-sm" value="N/A" required>'
            cols += '                </div>'
            ...
            cols += '                        <input type="number" name="airfare_usd[]" oninput="subtotalusd()" style="height: 35px;" id="airfare_usd" class="airfare_usd form-control form-control-sm input-sm" value="0" required>'
            cols += '                    </div>' 
            ...
            cols += '                        <input type="number" name="airfare_php[]" oninput="subtotalphp()" id="airfare_php" style="height: 35px;" class="airfare_php form-control" value="0" required>'
            cols += '                    </div>' 
            cols += '                </div>' 
            ...
            cols += '                    <div class="col-md-4 d-flex" id="container-amount">' 
            cols += '                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">USD: </span></label>'
            cols += '                        <input type="number" name="taxes_usd[]" oninput="subtotalusd()" id="taxes_usd" style="height: 35px;" class="taxes_usd form-control" value="0" required>'
            cols += '                    </div>' 

            cols += '                    <div class="col-md-4 d-flex" id="container-amount-php">' 
            cols += '                        <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">PHP: </span></label>'
            cols += '                        <input type="number" name="taxes_php[]" oninput="subtotalphp()" id="taxes_php" style="height: 35px;" class="taxes_php form-control" value="0" required>'
            cols += '                    </div>' 
            cols += '                </div>' 
            ...
            cols += '                    <div class="col-md-4 d-flex" id="container-amount">' 
            cols += '                    <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">USD: </span></label>'
            cols += '                        <input type="number" name="iata_usd[]" oninput="subtotalusd()" id="iata_usd" style="height: 35px;" class="iata_usd form-control" value="0" required>'
            cols += '                    </div>' 

            cols += '                    <div class="col-md-4 d-flex" id="container-amount-php">' 
            cols += '                        <label for="" class="font-weight-bold bg-dark p-2 w-50 text-center text-white" style="font-size: 13px"><span class="text-center">PHP: </span></label>'
            cols += '                        <input type="number" name="iata_php[]" oninput="subtotalphp()" id="iata_php" style="height: 35px;" class="iata_php form-control form-control-sm" value="0" required>'
            cols += '                    </div>' 
            cols += '                </div>' 
            ...
            cols += '                        <input type="number" name="airfare_sub_total_usd[]" oninput="" id="sub_total_usd" style="height: 35px;" class="sub_total_usd form-control" value="0" readonly>'
            cols += '                    </div>' 
            ...
            cols += '                        <input type="number" name="airfare_sub_total_php[]" oninput="" id="sub_total_php" style="height: 35px;" class="sub_total_php form-control form-control-sm" value="0" readonly>'
            cols += '                    </div>' 
            cols += '                </div>' 
            cols += '        </div>'
            cols += '    </div>'
            ...
            $("#addBtn").click(function(e){
                    ...
                    $.ajax({
                        ...
                        success : function (response){
                            ...
                            else if(response == "paymentmethodempty"){
                                Swal.fire({
                                    position: 'center',
                                    icon: 'error',
                                    title: 'Make sure the payment method is selected. Please try again Thankyou!',
                                    showConfirmButton: false,
                                    timer: 2000  
                                })
                            }
