<?php 
    ...
    $sqlu = "UPDATE notification SET status='seen' WHERE officials_Id='$officials_Id' AND form='SA'";
        ...
        <div class="row">
            ...
            <div class="col-md-10 qwe">
                ...
                <?php 
                    ...
                    $sql = "SELECT r.req_Id, r.officials_Id, r.form_Id, r.form, r.date_request, r.status, r.token, r.token_expire, o.officials_Id, o.name, s.sa_Id, s.sa_Number FROM request_list r INNER JOIN officials o ON r.officials_Id = o.officials_Id INNER JOIN sa s ON r.form_Id = s.sa_Id WHERE r.status='Pending'";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex" style="justify-content: space-around">
                                ...
                                <form action="" id="sa-accept-form" method="POST">
...
<script>
    ...
    $(document).ready(function(){
        ...
        //             method: "POST",
        //             data: $("#sa-accept-form").serialize() + "&action=confirmedReqSA",
