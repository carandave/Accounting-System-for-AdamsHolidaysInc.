        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="bg-success" style="width: 90%; padding: 8px 20px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light"> Check Voucher Form</h5>
                </div>
                <form action="" id="cv_Form" style="width: 90%; margin: 0 auto; border: 1px solid lightgray;" class="p-4" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <input type="date" name="date" id="" class="form-control form-control-sm " value="<?php echo $date; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="particular" id="" cols="3" rows="3" class="form-control"></textarea>
                            <!-- <input type="text" name="payee" id="payee" class="form-control form-control-sm " required> -->
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-9 d-flex justify-content-center align-items-center ml-0 pl-0">
                            <input type="text" name="cv_passengerName[]" id="cv_passengerName" class="ml-3 cv_passengerName form-control ml-0" value="N/A" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5">
                                    ...
                                    <div class="row" style="height: 100%;">
                                        <div class="col-md-6 d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center">
                                                ...
                                                <input type="radio" name="cv_paymentMethod" style="height: 50px;" onclick="selectedPaymentMethod()" value="USD" id="usdchose" class="cv_paymentMethodBtn" >
                                            </div>
                                        ...
                                        <div class="col-md-6 d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center">
                                                ...
                                                <input type="radio" name="cv_paymentMethod" onclick="selectedPaymentMethod()" value="PHP" id="phpchose" class="cv_paymentMethodBtn" >
                                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="acr" id="acr" value="0" class="acr form-control form-control-sm " required>
                        </div>
                    ...
                    <div class="p-4 mt-3 bg-dark" >
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="number" name="total_amount" id="total_amount" value="0" class="form-control form-control-sm " required>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="sum_of_pesos" id="amount_in_words" style="text-transform: uppercase;" value="N/A" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="check_no" id="" class="form-control form-control-sm " required>
                            </div>

                            <div class="col-md-4">
                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span><span class="text-light">Received By:</span></label>
                                <input type="text" name="received_by" id="" class="form-control form-control-sm " required>
                            </div>

                            <div class="col-md-4">
                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span><span class="text-light">Date Received:</span></label>
                                <input type="date" name="date_received" id="" class="form-control form-control-sm " required>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="prepared_by" id="" class="form-control form-control-sm " required>
                            </div>

                            <div class="col-md-4">
                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span><span class="text-light">Checked By:</span></label>
                                <input type="text" name="checked_by" id="" class="form-control form-control-sm " required>
                            </div>

                            <div class="col-md-4">
                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span><span class="text-light">Approved By:</span></label>
                                <input type="text" name="approved_by" id="" class="form-control form-control-sm " required>
                            </div>
                        </div>
                    </div>
...
<script>
        ...
        function convertAmountToText(totalAllAmount) {
            ...
            var cv_paymentMethod = document.getElementsByName('cv_paymentMethod');
    ...
    $("#addCheckVoucherBtn").click(function(e){
        ...
        $("#divNextCheckVoucher").append(
            ...
            <div class="row mt-3">
                        ...
                        <div class="col-md-6 d-flex justify-content-center align-items-center ml-0 pl-0">
                            <input type="text" name="cv_passengerName[]" id="cv_passengerName" class="ml-3 cv_passengerName form-control ml-0" value="N/A" required>
                        </div>

                        <div class="col-md-3 d-flex justify-content-center align-items-center ml-0 pl-0 ">
        ...
        // console.log("Hello World")
            $("#addBtn").click(function(e){
                    ...
                    $.ajax({
                        url: "add_process.php",
                        method: "POST",
                        data: $("#cv_Form").serialize() + "&action=AddCV",
                        success : function (response){
                            if(response == "Success"){
                                Swal.fire({
                                    position: 'center',
                                    icon: 'success',
                                    title: 'Successfully Added CV!',
                                    showConfirmButton: false,
                                    timer: 1300  
                                }).then(function(){
