    ...
    <div class="fluid-container py-5" style="min-height: 100vh; width: 100%; background: #fff">
        ...
        <div class="row">
            ...
            <?php 
                ...
                $sql = "SELECT s.sa_Id, s.sa_Number, s.name_of_client, s.agent, s.group_name, s.particulars, s.co, s.date, s.po_No, s.or_No, s.prepared_by, s.checked_by, s.approved_by, s.sa_paymentMethod, s.sa_acr, s.sa_passengerName, s.tourcost_usd, s.tourcost_arc, s.tourcost_php, s.taxes_usd, s.taxes_arc, s.taxes_php, s.tip_fund_usd, s.tip_fund_arc, s.tip_fund_php, s.travel_insurance_usd, s.travel_insurance_arc,s.travel_insurance_php, s.parent_data_visa_fee_passengerName, s.parent_data_visa_fee_usd, s.parent_data_visa_fee_arc, s.parent_data_visa_fee_php, s.parent_data_other_passengerName, s.parent_data_other_usd, s.parent_data_other_arc, s.parent_data_other_php, s.select_sub_total_usd, s.select_sub_total_php, s.sub_total_usd, s.sub_total_php, s.total_of_sub_total, s.sa_date_deposit, s.sa_amount_deposit, s.total_amount_deposit, s.total_amount, s.archive, v.sa_Id, v.nested_data_visa_fee_passengerName, v.nested_data_visa_fee_usd,  v.nested_data_visa_fee_arc,  v.nested_data_visa_fee_php, o.sa_Id, o.nested_data_other_passengerName, o.nested_data_other_usd,  o.nested_data_other_arc, o.nested_data_other_php FROM sa s INNER JOIN sa_nested_table v ON s.sa_Id = v.sa_Id INNER JOIN sa_nested_other_table o ON s.sa_Id = o.sa_Id WHERE s.sa_Id='$saId'";
            ...
            <div class="col-md-10">
                <div class="bg-success" style="width: 90%; padding: 15px 35px; margin: 0 auto;" >
                    <h5 class="mb-0 text-light text-center">STATEMENT OF ACCOUNT VIEW FORM</h5>
                </div>
                <form action="" id="sa_Form" style="width: 90%; margin: 0 auto; border: 1px solid lightgray;" class="p-4" >
                <input type="text" name="by" id="" value="<?php echo $userName;?>" class="d-none form-control form-control-sm" readonly>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name_of_client" id="name_of_client" value="<?php echo $rows['name_of_client']?>" class="form-control form-control-sm " readonly>
                        </div>

                        <div class="col-md-6">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Agent:</label>
                            <input type="text" name="agent" id="agent" value="<?php echo $rows['agent']?>" class="form-control form-control-sm" readonly>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea cols="10" rows="3" name="group_name" id="group_name" value="<?php echo $rows['group_name']?>" class="form-control form-control-sm" readonly>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea cols="10" rows="4" name="particulars" id="particulars" value="<?php echo $rows['particulars']?>" class="form-control form-control-sm" readonly>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="co" id="co" value="<?php echo $rows['co']?>" class="form-control form-control-sm" readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date" id="date" value="<?php echo $rows['date']?>" class="form-control form-control-sm " readonly>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="po_no" id="po_no" value="<?php echo $rows['po_No']?>" class="form-control form-control-sm " readonly>
                        </div>

                        <div class="col-md-6">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>AR No.:</label>
                            <input type="text" name="or_no" id="or_no" value="<?php echo $rows['or_No']?>" class="form-control form-control-sm" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="sa_preparedBy" id="ar_preparedBy" value="<?php echo $rows['prepared_by']?>" class="form-control form-control-sm" readonly>
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Checked By:</label>
                            <input type="text" name="sa_checkedBy" id="ar_checkedBy" value="<?php echo $rows['checked_by']?>" class="form-control form-control-sm" readonly>
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>Approved By:</label>
                            <input type="text" name="sa_approvedBy" id="ar_approvedBy" value="<?php echo $rows['approved_by']?>" class="form-control form-control-sm" readonly>
                        </div>
                    </div>
                            ...
                            <div class="row p-3">
                                <div class="col-md-6 " style="border-right: 3px solid white">
                                    <div class="d-flex ">
                                        ...
                                        <input type="radio" name="sa_paymentMethod" onclick="selectedUsdPhpHotel()" value="USD" id="usdChosePaymentMethod" class="form-control " disabled
                                ...
                                <div class="col-md-6" style="border-left: 3px solid white">
                                    <div class="d-flex ">
                                        ...
                                        <input type="radio" name="sa_paymentMethod" onclick="selectedUsdPhpHotel()" value="PHP" id="phpChosePaymentMethod" class="form-control " disabled 
                    ...
                    <div class="row bg-warning p-3 m-1 " id="acr-div">
                        <div class="col-md-12 ">
                            ...
                            <input type="number" name="sa_acr" id="sa_acr" class="form-control form-control-sm" required value="<?php echo $rows['sa_acr'];?>">
                        </div>
                    </div>
                    ...
                    <?php 
                        ...
                        $parent_data_visa_fee_passengerNameArr[$sa_passengerNameArrIndex];
                            ...
                            <div class="p-3 bg-success" style="border: 1px solid lightgray;">
                                <div class="">
                                        ...
                                        <!-- <div class="d-flex align-items-center" style="justify-content: space-between">'
                                            ...
                                            <input type="button" class="btn btn-danger btn-sm" style="border: 0; cursor: pointer; margin-bottom: 0.5rem" onclick="select1()" value="Remove" id="removePassengerBtn">
                                        </div> -->
                                    <input type="text" name="sa_passengerName[]" id="sa_passengerName" value="<?php echo $sa_passengerNameArr[$sa_passengerNameArrIndex];?>" class="form-control form-control-sm" readonly>
                                </div>
                                                ...
                                                <h6 class="text-light">TOUR COST</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="tourcost_usd[]" oninput="select1();" id="tourcost1_usd" value="<?php echo $tourcost_usdArr[$sa_passengerNameArrIndex];?>" class="tourcost1_usd form-control form-control-sm" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            ...
                                                            <input type="number" name="tourcost_arc[]" oninput="" id="tourcost1_arc" value="<?php echo $tourcost_arcArr[$sa_passengerNameArrIndex];?>" class="tourcost1_arc form-control form-control-sm" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="tourcost_php[]" oninput="selectphp1();" id="tourcost1_php" value="<?php echo $tourcost_phpArr[$sa_passengerNameArrIndex];?>" class="tourcost1_php form-control form-control-sm" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="row mt-2" > -->
                                                ...
                                                <h6 class="text-light">TAXES</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="taxes_usd[]" oninput="select1();" id="taxes1_usd" value="<?php echo $taxes_usdArr[$sa_passengerNameArrIndex];?>" class="taxes1_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="taxes_arc[]" oninput="" id="taxes1_arc" value="<?php echo $taxes_arcArr[$sa_passengerNameArrIndex];?>" class="taxes1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="taxes_php[]" oninput="selectphp1();" id="taxes1_php" value="<?php echo $taxes_phpArr[$sa_passengerNameArrIndex];?>" class="taxes1_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="row mt-2" > -->
                                                ...
                                                <h6 class="text-light">TIP FUND</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="tip_fund_usd[]" oninput="select1();" id="tip_fund1_usd" value="<?php echo $tip_fund_usdArr[$sa_passengerNameArrIndex];?>" class="tip_fund1_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="tip_fund_arc[]" oninput="" id="tip_fund1_arc" value="<?php echo $tip_fund_arcArr[$sa_passengerNameArrIndex];?>" class="tip_fund1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="tip_fund_php[]" oninput="selectphp1();" value="<?php echo $tip_fund_phpArr[$sa_passengerNameArrIndex];?>" id="tip_fund1_php" class="tip_fund1_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- <div class="row mt-2" > -->
                                                ...
                                                <h6 class="text-light">TRAVEL INSURANCE</h6>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="travel_insurance_usd[]" oninput="select1();" id="travel_insurance1_usd" value="<?php echo $travel_insurance_usdArr[$sa_passengerNameArrIndex];?>" class="travel_insurance1_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="travel_insurance_arc[]" oninput="" id="travel_insurance1_arc" value="<?php echo $travel_insurance_arcArr[$sa_passengerNameArrIndex];?>" class="travel_insurance1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="travel_insurance_php[]" oninput="selectphp1();" id="travel_insurance1_php" value="<?php echo $travel_insurance_phpArr[$sa_passengerNameArrIndex];?>" class="travel_insurance1_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <!-- Dito na tayo sa pag piprint ng data parent sa visa fee -->
                                                    ...
                                                    <div class="row pr-3" >
                                                        <div class="col-md-12 ">
                                                            ...
                                                            <input type="text" name="visa_fee_name[]" oninput="" id="visa_fee1_name" value="<?php echo $parent_data_visa_fee_passengerNameArr[$sa_passengerNameArrIndex];?>" class="visa_fee1_name visa-fee-parent<?php echo $defaultvalVisaFeeParent;?> form-control form-control-sm pr-3" readonly>
                                                        </div>

                                                        <!-- <div class="col-md-2">
                                                            <label for="" class="font-weight-bold " style="visibility: hidden"><span class="text-danger">*</span>VISA FEE:</label>
                                                            <input type="button" class="addVisaFeeTab1 btn btn-dark btn-sm" style="border: 0; cursor: pointer;" value="ADD VISA FEE" id="addVisaFeeTab1">
                                                        </div> -->
                                                    </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="visa_fee_usd[]" oninput="select1();" id="visa_fee1_usd" value="<?php echo $parent_data_visa_fee_usdArr[$sa_passengerNameArrIndex]?>" class="visa_fee1_usd Parent<?php echo $defaultvalVisaFeeParent;?>_visa_fee_usd  form-control form-control-sm" required>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="visa_fee_arc[]" oninput="" id="visa_fee1_arc" value="<?php echo $parent_data_visa_fee_arcArr[$sa_passengerNameArrIndex]?>" class="visa_fee1_arc form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="visa_fee_php[]" oninput="selectphp1();" id="" value="<?php echo $parent_data_visa_fee_phpArr[$sa_passengerNameArrIndex]?>" class="visa_fee1_php Parent<?php echo $defaultvalVisaFeeParent;?>_visa_fee_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-3 d-none">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="" oninput="" id="" class="nested<?php echo $defaultvalVisaFeeParent;?>_subtotal_usd nested_visa_sub_usd form-control form-control-sm" value="0" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="" oninput="" id="" class="nested<?php echo $defaultvalVisaFeeParent;?>_subtotal_php nested_visa_sub_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    // $nested_data_visa_fee_passengerNameArr
                                                    // $nested_data_visa_fee_usdArr
                                                    // $nested_data_visa_fee_arcArr
                                                    // $nested_data_visa_fee_phpArr
                                                            ...
                                                            foreach ($nested_data_visa_fee_passengerNameArr as $index => $passenger) {
                                                                ...
                                                                if($sa_passengerNameArrIndex == $index){
                                                                    foreach ($passenger as $childIndex => $childName) {
                                                                        ...
                                                                        $printvisafefee .= '<div class="col-md-12">';
                                                                        $printvisafefee .= '<label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>';
                                                                        $printvisafefee .= '<input type="text" name="nested_visa_fee_name['.$index.'][]" oninput="" id="nested_'.$index.'_visa_fee_name" class="nested_'.$index.'_visa_fee_name  nested_visa_fee_name_readonly form-control form-control-sm" value="'.$childName.'" readonly>';
                                                                        $printvisafefee .= '</div>';
                                                                        $printvisafefee .= '</div>';
                                                                        ...
                                                                        $printvisafefee .= '<input type="text" name="nested_visa_fee_usd['.$index.'][]" oninput="nested'.$index.'VisaFeeCal()" id="nested_'.$index.'_visa_fee_usd " class="nested_'.$index.'_visa_fee_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="'.$nested_data_visa_fee_usdArr[$index][$childIndex].'" readonly>';
                                                                        $printvisafefee .= '</div>';
                                                                        ...
                                                                        $printvisafefee .= '<input type="text" name="nested_visa_fee_arc['.$index.'][]" oninput="" id="nested_'.$index.'_visa_fee_arc" class="nested_'.$index.'_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="'.$nested_data_visa_fee_arcArr[$index][$childIndex].'" readonly>';
                                                                        $printvisafefee .= '</div>';

                                                                        $printvisafefee .= '<div class="col-md-4">';
                                                                        $printvisafefee .= '<label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>';
                                                                        $printvisafefee .= '<input type="text" name="nested_visa_fee_php['.$index.'][]" oninput="nested'.$index.'VisaFeePhpCal()" id="nested_'.$index.'_visa_fee_php" class="nested_'.$index.'_visa_fee_php nested_visa_fee_arc_readonly form-control form-control-sm" value="'.$nested_data_visa_fee_phpArr[$index][$childIndex].'" readonly>';
                                                                        $printvisafefee .= '</div>';

                                                                        $printvisafefee .= '</div>';
                                                                        $printvisafefee .= '</div>';
                                                                        echo $printvisafefee;
                                                                        // echo "  Child $childIndex: $childName\n";
                                                                        // echo "</br>";
                                                                        // echo "    USD: {$nested_data_visa_fee_usdArr[$index][$childIndex]}\n";
                                                                        // echo "</br>";
                                                                        // echo "    ARC: {$nested_data_visa_fee_arcArr[$index][$childIndex]}\n";
                                                                        // echo "</br>";
                                                                        // echo "    PHP: {$nested_data_visa_fee_phpArr[$index][$childIndex]}\n";
                                                                        // echo "</br>";
                                                                    }
                                                                }
                                                                echo "\n";
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row pr-3">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" name="other_name[]" oninput="" id="other1_name" value="<?php echo $parent_data_other_passengerNameArr[$sa_passengerNameArrIndex - 1] ?>"  class="other1_name other-parent<?php echo $defaultvalOtherParent;?> form-control form-control-sm" value="N/A" readonly>
                                                        </div>

                                                        <!-- <div class="col-md-2">
                                                            <label for="" class="font-weight-bold" style="visibility: hidden"><span class="text-danger">*</span>OTHER:</label>
                                                            <input type="button" class="addOtherTab1 btn btn-dark btn-sm" style="border: 0; cursor: pointer;" value="ADD OTHER" id="addOtherTab1">
                                                        </div> -->
                                                    </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>
                                                            <input type="number" name="other_usd[]" oninput="select1();" id="other1_usd" value="<?php echo $parent_data_other_usdArr[$sa_passengerNameArrIndex - 1]?>" class="other1_usd Parent<?php echo $defaultvalOtherParent;?>_other_usd form-control form-control-sm" value="0" readonly>
                                                        ...
                                                        <div class="col-md-4" style="visibility: hidden">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>
                                                            <input type="number" name="other_arc[]" oninput="" id="" value="<?php echo $parent_data_other_arcArr[$sa_passengerNameArrIndex]?>" class="other1_arc form-control form-control-sm " value="0" required>
                                                            <input type="number" name="other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>
                                                            <input type="number" name="other_php[]" oninput="selectphp1();" id="" value="<?php echo $parent_data_other_phpArr[$sa_passengerNameArrIndex - 1]?>" class="other1_php Parent<?php echo $defaultvalOtherParent;?>_other_php form-control form-control-sm" value="0" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-3 d-none">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="" oninput="" id="" class="nested<?php echo $defaultvalOtherParent;?>_other_subtotal_usd nested_other_sub_usd form-control form-control-sm" value="0" required>
                                                            <input type="number" name="" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED 1 SUBTOTAL PHP:</label>
                                                            <input type="number" name="" oninput="" id="" class="nested<?php echo $defaultvalOtherParent;?>_other_subtotal_php nested_other_php form-control form-control-sm" value="0" required>
                                                        </div>
                                                    </div>
                                                            ...
                                                            foreach ($nested_data_other_passengerNameArr as $index => $passenger) {
                                                                ...
                                                                if($sa_passengerNameArrIndex == $index){
                                                                    foreach ($passenger as $childIndex => $childName) {
                                                                        ...
                                                                        $printother .= '<div class="col-md-12">';
                                                                        
                                                                        $printother .= '<label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER:</label>';
                                                                        $printother .= '<input type="text" name="nested_other_name['.$index.'][]" oninput="" id="nested_'.$index.'_other_name" class="nested_'.$index.'_other_name nested_visa_fee_name_readonly form-control form-control-sm" value="'.$childName.'" readonly>';
                                                                        $printother .= '</div>';
                                                                        $printother .= '</div>';
                                                                        ...
                                                                        $printother .= '<input type="text" name="nested_other_usd['.$index.'][]" oninput="nested'.$index.'OtherUsdCal();" id="nested_'.$index.'_other_usd" class="nested_'.$index.'_other_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="'.$nested_data_other_usdArr[$index][$childIndex].'" readonly>';
                                                                        $printother .= '</div>';
                                                                        ...
                                                                        $printother .= '<input type="text" name="nested_other_arc['.$index.'][]" oninput="" id="nested_'.$index.'_other_arc" class="nested_'.$index.'_other_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="'.$nested_data_other_arcArr[$index][$childIndex].'" readonly>';
                                                                        $printother .= '</div>';

                                                                        $printother .= '<div class="col-md-4">';
                                                                        $printother .= '<label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>';
                                                                        $printother .= '<input type="text" name="nested_other_php['.$index.'][]" oninput="nested'.$index.'OtherPhpCal();" id="nested_'.$index.'_other_php" class="nested_'.$index.'_other_php nested_visa_fee_php_readonly form-control form-control-sm" value="'.$nested_data_other_phpArr[$index][$childIndex].'" readonly>';
                                                                        $printother .= '</div>';
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" name="select1_total_usd[]" oninput="" id="select1_total_usd" class="select1_total_usd form-control form-control-sm" value="<?php echo $select_sub_total_usdArr[$sa_passengerNameArrIndex - 1];?>" required>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" name="select1_total_php[]" oninput="" id="select1_total_php" class="select1_total_php form-control form-control-sm" value="<?php echo $select_sub_total_phpArr[$sa_passengerNameArrIndex - 1];?>" required>
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4" >
                            ...
                            <input type="number" name="sub_total_usd" oninput="" id="sub_total_usd" class="sub_total_usd form-control form-control-sm" value="<?php echo $rows['sub_total_usd'];?>" readonly="true">
                        </div>

                        <div class="col-md-4">
                            <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>SUB TOTAL PHP:</label>
                            <input type="number" name="sub_total_php" oninput="" id="sub_total_php" class="sub_total_php form-control form-control-sm" value="<?php echo $rows['sub_total_php'];?>" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-8" >
                            ...
                            <input type="number" name="total_of_sub_total" oninput="" id="total_of_sub_total" class="total_of_sub_total form-control form-control-sm" value="<?php echo $rows['total_of_sub_total'];?>" readonly="true">
                        </div>
                    </div>
                    ...
                    <div class="p-3 pb-0 mt-4" style="border: 1px solid lightgray;">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="sa_date_deposit[]" oninput="" id="sa_date_deposit" class="mt-2 sa_date_deposit form-control form-control-sm" value="<?php echo $sa_date_depositArrvalue;?>" readonly>
                                        <?php } ?>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="sa_amount_deposit[]" oninput="addDeposit()" id="sa_amount_deposit" class="mt-2 sa_amount_deposit form-control form-control-sm" value="<?php echo $sa_amount_depositArrvalue;?>" readonly>
                                        <?php } ?>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="total_amount_deposit" oninput="" id="total_amount_deposit" class="total_amount_deposit form-control form-control-sm" value="<?php echo $rows['total_amount_deposit']?>" readonly="true">
                            </div>
                            <!-- <div class="col-md-2">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="total_amount" oninput="" id="total_amount" class="total_amount form-control " value="<?php echo $rows['total_amount']?>" readonly="true">
                            </div>
                            <!-- <div class="col-md-2">
                                <label for="" class="font-weight-bold" style="visibility: hidden"><span class="text-danger mr-1">*</span>TOTAL AMOUNT DEPOSIT:</label>
                                <input type="text" name="total_amount_deposit" style="visibility: hidden" oninput="" id="total_amount_deposit" class="total_amount_deposit form-control form-control-sm" value="0" required>
...
<script>
    ...
    // $("#addVisaFeeTab").on("click", function(e) {
    ...
    //     VisaFeecols += '    <div class="col-md-12 ">'
    //     VisaFeecols += '        <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
    //     VisaFeecols += '        <input type="text" name="visa_fee_name[]" oninput="" id="visa_fee1_name" class="visa_fee1_name form-control form-control-sm pr-3" value="" required>'
    //     VisaFeecols += '    </div>'
    ...
    //     VisaFeecols += '        <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>USD:</label>'
    //     VisaFeecols += '        <input type="number" name="visa_fee_usd[]" oninput="select1();" id="visa_fee1_usd" class="visa_fee1_usd form-control form-control-sm" value="0" required>'
    ...
    //     VisaFeecols += '    <div class="col-md-4">'
    //     VisaFeecols += '        <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>ACR:</label>'
    //     VisaFeecols += '        <input type="number" name="visa_fee_arc[]" oninput="" id="visa_fee1_arc" class="visa_fee1_arc form-control form-control-sm" value="0" required>'
    ...
    //     VisaFeecols += '    <div class="col-md-4">'
    //     VisaFeecols += '        <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>PHP:</label>'
    //     VisaFeecols += '        <input type="number" name="visa_fee_php[]" oninput="selectphp1();" id="" class="visa_fee1_php form-control form-control-sm" value="0" required>'
    //     VisaFeecols += '    </div>'
    //     VisaFeecols += '</div>'

    //     $("#netxVisaFeeTab").append(VisaFeecols)
    // // counterVisaFee++;
    // })
    ...
    function zeroValue(){
        ...
        // let nested_zero_usdInput = document.querySelectorAll('.nested_zero_usd');

        // // console.log("Nested Zero: " + nested_zero_usdInput)
        // // console.log(tourcost1_usdInput)
        // nested_zero_usdInput.forEach(function(nested_zero_usdInput_item, index) {
        
        
        // nested_zero_usdInput_item.addEventListener("change", (event) => {
        //     if(nested_zero_usdInput_item.value == ""){
        //         // alert("Walang value si " + tourcost1_usdInput_item.value);
        //         nested_zero_usdInput_item.value = 0;
        //         subtotalselectUsd();
        //     }
        //     else{
        //         // alert("Merong value");
    ...
    $("#addDepositTab").click(function(e){
        ...
        $("#divNextDeposit").append(
            `<div class="row mt-4">
                <div class="col-md-6">
                    <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>DATE:</label>
                    <input type="date" name="sa_date_deposit[]" oninput="" id="sa_date_deposit" class="sa_date_deposit form-control form-control-sm"  required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div id="container-amount-deposit">
                        <input type="number" name="sa_amount_deposit[]" oninput="addDeposit()" id="sa_amount_deposit" class="sa_amount_deposit form-control form-control-sm" value="0" required>
                    </div>
                </div>
    ...
    function subtotalselectUsd(){
            ...
            total_of_sub_total.value = parseFloat(sub_total_usd.value) + parseFloat(sub_total_php);
    ...
    function select1(){
        ...
        sub_total_usdDisplay.value = subTotalUsdCalculate;
        
        total_of_sub_totalDisplay.value = parseFloat(subTotalUsdCalculate) + parseFloat(sub_total_phpDisplay);
    ...
    $("#addOtherTab1").on("click", function(e) {
        ...
        Othercols += '        <input type="text" name="nested_other_name[1][]" oninput="" id="nested_1_other_name" class="nested_1_other_name   form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '        <input type="number" name="nested_other_usd[1][]" oninput="nested1OtherUsdCal()" id="nested_1_other_usd" class="nested_1_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        ...
        Othercols += '        <input type="number" name="nested_other_arc[1][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        ...
        Othercols += '        <input type="number" name="nested_other_php[1][]" oninput="nested1OtherPhpCal();" id="nested_1_other_php" class="nested_1_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[2][]" oninput="" id="nested_2_other_name" class="nested_2_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[2][]" oninput="nested2OtherUsdCal()" id="nested_2_other_usd" class="nested_2_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[2][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[2][]" oninput="nested2OtherPhpCal()" id="nested_2_other_php" class="nested_2_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
    ...
    valuesNested3OtherPhp = valuesNested3OtherPhp.map(item => (item == "" ? 0 : item));
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[3][]" oninput="" id="nested_3_other_name" class="nested_3_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[3][]" oninput="nested3OtherUsdCal()" id="nested_3_other_usd" class="nested_3_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[3][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[3][]" oninput="nested3OtherPhpCal()" id="nested_3_other_php" class="nested_3_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[4][]" oninput="" id="nested_4_other_name" class="nested_4_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[4][]" oninput="nested4OtherUsdCal()" id="nested_4_other_usd" class="nested_4_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[4][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[4][]" oninput="nested4OtherPhpCal()" id="nested_4_other_php" class="nested_4_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
    ...
    valuesNested5OtherPhp = valuesNested5OtherPhp.map(item => (item == "" ? 0 : item));
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[5][]" oninput="" id="nested_5_other_name" class="nested_5_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[5][]" oninput="nested5OtherUsdCal()" id="nested_5_other_usd" class="nested_5_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[5][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[5][]" oninput="nested5OtherPhpCal()" id="nested_5_other_php" class="nested_5_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
...
valuesNested6OtherPhp = valuesNested6OtherPhp.map(item => (item == "" ? 0 : item));
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[6][]" oninput="" id="nested_6_other_name" class="nested_6_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[6][]" oninput="nested6OtherUsdCal()" id="nested_6_other_usd" class="nested_6_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[6][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[6][]" oninput="nested6OtherPhpCal()" id="nested_6_other_php" class="nested_6_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[7][]" oninput="" id="nested_7_other_name" class="nested_7_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[7][]" oninput="nested7OtherUsdCal()" id="nested_7_other_usd" class="nested_7_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[7][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[7][]" oninput="nested7OtherPhpCal()" id="nested_7_other_php" class="nested_7_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[8][]" oninput="" id="nested_8_other_name" class="nested_8_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[8][]" oninput="nested8OtherUsdCal()" id="nested_8_other_usd" class="nested_8_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[8][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[8][]" oninput="nested8OtherPhpCal()" id="nested_8_other_php" class="nested_8_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[9][]" oninput="" id="nested_9_other_name" class="nested_9_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[9][]" oninput="nested9OtherUsdCal()" id="nested_9_other_usd" class="nested_9_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[9][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[9][]" oninput="nested9OtherPhpCal()" id="nested_9_other_php" class="nested_9_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-12 ">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER NAME:</label>'
        Othercols += '        <input type="text" name="nested_other_name[10][]" oninput="" id="nested_10_other_name" class="nested_10_other_name form-control form-control-sm pr-3" value="N/A" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
        ...
        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        Othercols += '        <input type="number" name="nested_other_usd[10][]" oninput="nested10OtherUsdCal()" id="nested_10_other_usd" class="nested_10_other_usd nested_other_usd_readonly form-control form-control-sm" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_usdD[]" oninput="select1();" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        Othercols += '        <input type="number" name="nested_other_arc[10][]" oninput="" id="" class=" form-control form-control-sm nested_other_arc_readonly" value="0" required>'
        Othercols += '        <input type="number" name="nested_other_arcD[]" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'

        Othercols += '    <div class="col-md-4">'
        Othercols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        Othercols += '        <input type="number" name="nested_other_php[10][]" oninput="nested10OtherPhpCal()" id="nested_10_other_php" class="nested_10_other_php nested_other_php_readonly form-control form-control-sm" value="0" required>'
        Othercols += '    </div>'
        Othercols += '</div>'
    ...
    $("#addVisaFeeTab1").on("click", function(e) {
        ...
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[1][]" oninput="" id="nested_1_visa_fee_name" class="nested_1_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'

        // VisaFeecols += '    <div class="col-md-2">'
        // VisaFeecols += '        <input type="button" class="btn btn-danger btn-sm" style="border: 0; cursor: pointer; margin-bottom: 0.5rem" onclick="select1()" value="Remove" id="removeNestedVisaFeeBtn">'
        // VisaFeecols += '    </div>'
        VisaFeecols += '</div>'

        VisaFeecols += '<div class="row mt-3">'
        VisaFeecols += '    <div class="col-md-4" id="container-nested-remove">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[1][]" oninput="nested1VisaFeeCal()" id="nested_1_visa_fee_usd" class="nested_1_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[1][]" oninput="" id="nested_1_visa_fee_arc" class="nested_1_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[1][]" oninput="nested1VisaFeePhpCal();" id="nested_1_visa_fee_php" class="nested_1_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
        VisaFeecols += '</div>'
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[2][]" oninput="" id="nested_2_visa_fee_name" class="nested_2_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        // VisaFeecols += '    <div class="col-md-2">'
        // VisaFeecols += '        <label for="" class="d-none font-weight-bold "><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        // VisaFeecols += '        <input type="button" class="btn btn-danger btn-sm" style="border: 0; cursor: pointer; margin-bottom: 0.5rem" onclick="select1()" value="Remove" id="removeNestedVisaFeeBtn">'
        // VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[2][]" oninput="nested2VisaFeeCal();" id="nested_2_visa_fee_usd" class="nested_2_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[2][]" oninput="" id="nested_2_visa_fee_arc" class="nested_2_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[2][]" oninput="nested2VisaFeePhpCal();" id="nested_2_visa_fee_php" class="nested_2_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[3][]" oninput="" id="nested_3_visa_fee_name" class="nested_3_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[3][]" oninput="nested3VisaFeeCal();" id="nested_3_visa_fee_usd" class="nested_3_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[3][]" oninput="" id="nested_3_visa_fee_arc" class="nested_3_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[3][]" oninput="nested3VisaFeePhpCal();" id="nested_3_visa_fee_php" class="nested_3_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
    ...
    valuesNested4VisaFeePhp = valuesNested4VisaFeePhp.map(item => (item == "" ? 0 : item));
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[4][]" oninput="" id="nested_4_visa_fee_name" class="nested_4_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[4][]" oninput="nested4VisaFeeCal();" id="nested_4_visa_fee_usd" class="nested_4_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[4][]" oninput="" id="nested_4_visa_fee_arc" class="nested_4_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[4][]" oninput="nested4VisaFeePhpCal();" id="nested_4_visa_fee_php" class="nested_4_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[5][]" oninput="" id="nested_5_visa_fee_name" class="nested_5_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[5][]" oninput="nested5VisaFeeCal();" id="nested_5_visa_fee_usd" class="nested_5_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[5][]" oninput="" id="nested_5_visa_fee_arc" class="nested_5_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[5][]" oninput="nested5VisaFeePhpCal();" id="nested_5_visa_fee_php" class="nested_5_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[6][]" oninput="" id="nested_6_visa_fee_name" class="nested_6_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[6][]" oninput="nested6VisaFeeCal();" id="nested_6_visa_fee_usd" class="nested_6_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[6][]" oninput="" id="nested_6_visa_fee_arc" class="nested_6_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[6][]" oninput="nested6VisaFeePhpCal();" id="nested_6_visa_fee_php" class="nested_6_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[7][]" oninput="" id="nested_7_visa_fee_name" class="nested_7_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[7][]" oninput="nested7VisaFeeCal();" id="nested_7_visa_fee_usd" class="nested_7_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[7][]" oninput="" id="nested_7_visa_fee_arc" class="nested_7_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[7][]" oninput="nested7VisaFeePhpCal();" id="nested_7_visa_fee_php" class="nested_7_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[8][]" oninput="" id="nested_8_visa_fee_name" class="nested_8_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[8][]" oninput="nested8VisaFeeCal();" id="nested_8_visa_fee_usd" class="nested_8_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[8][]" oninput="" id="nested_8_visa_fee_arc" class="nested_8_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[8][]" oninput="nested8VisaFeePhpCal();" id="nested_8_visa_fee_php" class="nested_8_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
...
function nested9VisaFeeCal(){
        ...
        VisaFeecols += '    <div class="col-md-12 ">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
        VisaFeecols += '        <input type="text" name="nested_visa_fee_name[9][]" oninput="" id="nested_9_visa_fee_name" class="nested_9_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
        VisaFeecols += '    </div>'
        ...
        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[9][]" oninput="nested9VisaFeeCal();" id="nested_9_visa_fee_usd" class="nested_9_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[9][]" oninput="" id="nested_9_visa_fee_arc" class="nested_9_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'

        VisaFeecols += '    <div class="col-md-4">'
        VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
        VisaFeecols += '        <input type="number" name="nested_visa_fee_php[9][]" oninput="nested9VisaFeePhpCal();" id="nested_9_visa_fee_php" class="nested_9_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
        VisaFeecols += '    </div>'
        VisaFeecols += '</div>'
        ...
        function nested10VisaFeeCal(){
            ...
            VisaFeecols += '    <div class="col-md-12 ">'
            VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>VISA FEE:</label>'
            VisaFeecols += '        <input type="text" name="nested_visa_fee_name[10][]" oninput="" id="nested_10_visa_fee_name" class="nested_10_visa_fee_name form-control form-control-sm pr-3" value="N/A" required>'
            VisaFeecols += '    </div>'
            ...
            VisaFeecols += '    <div class="col-md-4">'
            VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
            VisaFeecols += '        <input type="number" name="nested_visa_fee_usd[10][]" oninput="nested10VisaFeeCal();" id="nested_10_visa_fee_usd" class="nested_10_visa_fee_usd nested_zero_usd nested_visa_fee_usd_readonly form-control form-control-sm" value="0" required>'
            VisaFeecols += '        <input type="number" name="visa_fee_usdD[]" oninput="select1();" id="visa_fee1_usdD" class="visa_fee1_usdD d-none form-control form-control-sm" value="0" required>'
            VisaFeecols += '    </div>'

            VisaFeecols += '    <div class="col-md-4">'
            VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
            VisaFeecols += '        <input type="number" name="nested_visa_fee_arc[10][]" oninput="" id="nested_10_visa_fee_arc" class="nested_10_visa_fee_arc nested_visa_fee_arc_readonly form-control form-control-sm" value="0" required>'
            VisaFeecols += '        <input type="number" name="visa_fee_arcD[]" oninput="" id="visa_fee1_arcD" class="visa_fee1_arcD d-none form-control form-control-sm" value="0" required>'
            VisaFeecols += '    </div>'

            VisaFeecols += '    <div class="col-md-4">'
            VisaFeecols += '        <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
            VisaFeecols += '        <input type="number" name="nested_visa_fee_php[10][]" oninput="nested10VisaFeePhpCal();" id="nested_10_visa_fee_php" class="nested_10_visa_fee_php nested_zero_php nested_visa_fee_php_readonly form-control form-control-sm" value="0" required>'
            VisaFeecols += '    </div>'
            VisaFeecols += '</div>'
    ...
    $("#addPassengerTab").on("click", function(e) {
            ...
            cols +=     '    <input type="button" class="btn btn-danger btn-sm" style="border: 0; cursor: pointer; margin-bottom: 0.5rem" onclick="select1()" value="Remove" id="removePassengerBtn">'
            cols +=     '</div>'
            cols += '    <input type="text" name="sa_passengerName[]" id="sa_passengerName" class="sa_passengerName form-control form-control-sm" required>'
            cols += '</div>'
            cols += '<div class="row mt-3">'
            cols += '   <div class="col-md-3 d-flex justify-content-center" style="align-items: self-end;">'
            cols += '       <select name="" class="form-control select-Fee-'+counter+'" >'
            ...
            cols += '            <!-- TOUR COST ROW -->'
            cols += '            <div class="select-tourCost-'+counter+' row" >'
            ...
            cols += '                            <input type="number" name="tourcost_usd[]" oninput="select1()" id="tourcost1_usd" class="tourcost1_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                            <input type="number" name="tourcost_arc[]" oninput="" id="tourcost_1arc" class="tourcost1_arc form-control form-control-sm" value="0" required>'
            ...
            cols += '                           <input type="number" name="tourcost_php[]" oninput="selectphp1()" id="tourcost1_php" class="tourcost1_php form-control form-control-sm" value="0" required>'
            cols += '                        </div>'
            cols += '                   </div>'
            cols += '                </div>'
            cols += '           </div>'
            ...
            cols += '            <!-- TAXES ROW -->'
            cols += '           <div class="select-taxes-'+counter+' row mt-2" >'
            cols += '               <div class="col-md-12">'
            ...
            cols += '                        <div class="col-md-4" id="container-amount">'
            cols += '                           <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
            cols += '                            <input type="number" name="taxes_usd[]" oninput="select1()" id="taxes1_usd" class="taxes1_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                        <div class="col-md-4">'
            cols += '                           <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
            cols += '                           <input type="number" name="taxes_arc[]" oninput="" id="taxes1_arc" class="taxes1_arc form-control form-control-sm" value="0" required>'
            ...
            cols += '                        <div class="col-md-4">'
            cols += '                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
            cols += '                            <input type="number" name="taxes_php[]" oninput="selectphp1()" id="taxes1_php" class="taxes1_php form-control form-control-sm" value="0" required>'
            cols += '                        </div>'
            cols += '                    </div>'
            cols += '                </div>'
            cols += '            </div>'
            ...
            cols += '            <!-- TIP FUND ROW -->'
            cols += '            <div class="select-tipFund-'+counter+' row mt-2" >'
            cols += '                <div class="col-md-12">'
            ...
            cols += '                        <div class="col-md-4" id="container-amount">'
            cols += '                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
            cols += '                            <input type="number" name="tip_fund_usd[]" oninput="select1()" id="tip_fund1_usd" class="tip_fund1_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                        <div class="col-md-4">'
            cols += '                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
            cols += '                            <input type="number" name="tip_fund_arc[]" oninput="" id="tip_fund1_arc" class="tip_fund1_arc form-control form-control-sm" value="0" required>'
            ...
            cols += '                       <div class="col-md-4">'
            cols += '                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
            cols += '                            <input type="number" name="tip_fund_php[]" oninput="selectphp1()" id="tip_fund1_php" class="tip_fund1_php form-control form-control-sm" value="0" required>'
            cols += '                        </div>'
            cols += '                    </div>'
            cols += '                </div>'
            cols += '            </div>'
            ...
            cols += '            <div class="select-travelInsurance-'+counter+' row mt-2" >'
            cols += '                <div class="col-md-12">'
            ...
            cols += '                        <div class="col-md-4" id="container-amount">'
            cols += '                           <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
            cols += '                           <input type="number" name="travel_insurance_usd[]" oninput="select1()" id="travel_insurance1_usd" class="travel_insurance1_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                        <div class="col-md-4">'
            cols += '                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
            cols += '                            <input type="number" name="travel_insurance_arc[]" oninput="" id="travel_insurance1_arc" class="travel_insurance1_arc form-control form-control-sm" value="0" required>'
            ...
            cols += '                        <div class="col-md-4">'
            cols += '                           <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
            cols += '                           <input type="number" name="travel_insurance_php[]" oninput="selectphp1()" id="travel_insurance1_php" class="travel_insurance1_php form-control form-control-sm" value="0" required>'
            cols += '                       </div>'
            cols += '                    </div>'
            cols += '                </div>'
            cols += '            </div>'
            ...
            cols += '            <!-- VISA FEE ROW -->'
            cols += '            <div class="select-visaFee-'+counter+' row mt-2"  >'
            cols += '                <div class="col-md-12">'
            ...
            cols += '                           <input type="text" name="visa_fee_name[]" oninput="" id="visa_fee1_name" class="visa-fee-parent'+counter+' form-control form-control-sm pr-3" value="N/A" required>'
            cols += '                       </div>'
            ...
            cols += '                               <input type="button" class="btn btn-dark btn-sm" onclick="addVisaFee'+counter+'()" style="border: 0; cursor: pointer;" value="Add VISA FEE" id="addVisaFeeTab'+counter+'">'
            cols += '                           </div>'
            cols += '                   </div>'
            ...
            cols += '                        <div class="col-md-4" id="container-amount">'
            cols += '                           <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
            cols += '                            <input type="number" name="visa_fee_usd[]" oninput="select1()" id="" class="visa_fee1_usd Parent'+counter+'_visa_fee_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                        <div class="col-md-4">'
            cols += '                            <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
            cols += '                            <input type="number" name="visa_fee_arc[]" oninput="" id="visa_fee1_arc" class="visa_fee1_arc form-control form-control-sm" value="0" required>'
            ...
            cols += '                        <div class="col-md-4">'
            cols += '                           <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
            cols += '                            <input type="number" name="visa_fee_php[]" oninput="selectphp1()" id="" class="visa_fee1_php Parent'+counter+'_visa_fee_php form-control form-control-sm" value="0" required>'
            cols += '                        </div>'
            cols += '                    </div>'

            cols += '                   <div class="row mt-3 d-none">'
            cols += '                       <div class="col-md-4">'
            cols += '                           <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED '+counter+' SUBTOTAL USD:</label>'
            cols += '                           <input type="number" name="" oninput="" id="" class="nested'+counter+'_subtotal_usd nested_visa_sub_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                           <input type="number" name="" oninput="" id="" class="nested'+counter+'_subtotal_php nested_visa_sub_php form-control form-control-sm" value="0" required>'
            cols += '                       </div>'
            cols += '                   </div>'

            cols += '                   <div id="netxVisaFeeTab'+counter+'">'
            ...
            cols += '<div class="select-other-'+counter+' row mt-2" >'
            cols += '                                    <div class="col-md-12">'
                                         
            cols += '                                       <div class="row pr-3">'
            cols += '                                            <div class="col-md-10">'
            cols += '                                                <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>OTHER:</label>'
            cols += '                                                <input type="text" name="other_name[]" oninput="" id="other1_name" class="other-parent'+counter+' form-control form-control-sm" value="N/A" required>'
            cols += '                                            </div>'

            cols += '                                           <div class="col-md-2">'
            cols += '                                               <label for="" class="font-weight-bold " style="visibility: hidden"><span class="text-danger">*</span>OTHER:</label>'
            cols += '                                                <input type="button" class="btn btn-dark btn-sm" onclick="addOther'+counter+'()" style="border: 0; cursor: pointer;" value="Add OTHER" id="addOtherTab'+counter+'">'
            cols += '                                            </div>'
            cols += '                                       </div>'
            ...
            cols += '                                            <div class="col-md-4">'
            cols += '                                               <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>USD:</label>'
            cols += '                                                <input type="number" name="other_usd[]" oninput="select1();" id="" class="other1_usd Parent'+counter+'_other_usd form-control form-control-sm" value="0" required>'
            ...
            cols += '                                           <div class="col-md-4">'
            cols += '                                                <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>ACR:</label>'
            cols += '                                                <input type="number" name="other_arc[]" oninput="" id="other1_arc" class="other1_arc form-control form-control-sm" value="0" required>'
            ...
            cols += '                                           <div class="col-md-4">'
            cols += '                                                <label for="" class="font-weight-bold text-light"><span class="text-danger mr-1">*</span>PHP:</label>'
            cols += '                                                <input type="number" name="other_php[]" oninput="selectphp1();" id="" class="other1_php Parent'+counter+'_other_php form-control form-control-sm" value="0" required>'
            cols += '                                            </div>'
            cols += '                                        </div>'
            ...
            cols += '                                            <div class="col-md-4">'
            cols += '                                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED '+counter+' SUBTOTAL USD:</label>'
            cols += '                                                <input type="number" name="" oninput="" id="" class="nested'+counter+'_other_subtotal_usd nested_other_sub_usd form-control form-control-sm" value="0" required>'
            cols += '                                                <input type="number" name="" oninput="" id="" class=" d-none form-control form-control-sm" value="0" required>'
            cols += '                                            </div>'
            ...
            cols += '                                            <div class="col-md-4">'
            cols += '                                                <label for="" class="font-weight-bold"><span class="text-danger mr-1">*</span>NESTED 1 SUBTOTAL PHP:</label>'
            cols += '                                                <input type="number" name="" oninput="" id="" class="nested'+counter+'_other_subtotal_php nested_other_php form-control form-control-sm" value="0" required>'
            cols += '                                            </div>'
            cols += '                                        </div>'

            cols += '                                        <div id="netxOtherTab'+counter+'">'
            ...
            cols += '                                        <input type="number" name="select1_total_usd[]" oninput="" id="select1_total_usd" class="select1_total_usd form-control form-control-sm" value="0" required>'
            cols += '                                    </div>'
            ...
            cols += '                                        <input type="number" name="select1_total_php[]" oninput="" id="select1_total_php" class="select1_total_php form-control form-control-sm" value="0" required>'
            cols += '                                    </div>'
            cols += '                                </div>'
            cols += '                            </div> '
        ...
        // console.log("Hello World")
            $("#addBtn").click(function(e){
                    ...
                    $.ajax({
                        url: "add_process.php",
                        method: "POST",
                        data: $("#sa_Form").serialize() + "&action=AddSA",
                        success : function (response){
                            if(response == "Success"){
                                Swal.fire({
                                    position: 'center',
                                    icon: 'success',
                                    title: 'Successfully Added SA!',
